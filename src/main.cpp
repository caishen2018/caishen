...
uint256 hashGenesisBlock("0x15fa472b1eeb72b934ec6f51f912adeea5f9226c493968de5f945a7722bddbc7");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Caishen: starting difficulty is 1 / 2^12
...
{
    int64 nSubsidy = 2000000000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 40000000); // Caishen: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 432000; // Caishen: 3.5 days
static const int64 nTargetSpacing = 60; // Caishen: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x903cb90c66cb4eea5f54f6645976854682f1153afcaf546ee1eb9a511d861f84");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "A New Caishen is Born !";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2000000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9f357f4b570c401177f2dc5a58205384f2d60fdbd42bed84cf6a53fcd1cd36d571a1ef2d3e24264562fd8251cbbbf9e08e36893f40d7285648f520db21ca76ecd4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1518766361;
        block.nBits    = 504365644;
        block.nNonce   = 535377168;

        if (fTestNet)
        {
            block.nTime    = 1518766361;
            block.nNonce   = 1666980460;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3cfcb1da13026d24dddc6f62b3c70eb2d86876684532ad1009ac8d6fc8c21c9e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Caishen: increase each by adding 2 to bitcoin's value.
